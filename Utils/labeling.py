...
import json
import pandas as pd
ann_folder = '/opt/ml/input/Project/data/Validation/label'
ann_files = os.listdir(ann_folder)
image_folder = '/opt/ml/input/Project/data/Validation/image'
label_data = []
...
df.to_csv('./validation.csv',sep=',',columns=['path','label'],index=False)
